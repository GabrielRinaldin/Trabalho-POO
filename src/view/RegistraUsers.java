...
@FXML
 ...
 @FXML
 private TableColumn<User, String> TelefoneCollum;
 ...
 void Exit(ActionEvent event) {
	        ...
	        if(!PesquisaNome.getText().isEmpty() || !PesquisaNome.getText().equals("")) {
		        for(User cliente: lista) {
		        	if(cliente.getNome().contains(PesquisaNome.getText())) {
		        		...
		        		textAreaId.appendText(cliente.toString());
	...
	public void incluirCliente() {
		if(validacaoCampos()) {
			if(listaClientes.size() != 0) {
				...
				listaClientes.add(new User(cliente.getId() + 1, TxtTelefone.getText(), Txtemail.getText(), TxtName.getText()));
			} else {
				listaClientes.add(new User(1, TxtTelefone.getText(), Txtemail.getText(), TxtName.getText()));
			}
		...
		if(validacaoCampos()) {
	        ...
	        for(User cliente: lista) {
	        	if(cliente.getId().equals(Integer.parseInt(Txtid.getText()))) {
	        		...
	        		listaClientes.add(new User(Integer.parseInt(Txtid.getText()), TxtTelefone.getText(), Txtemail.getText(), TxtName.getText()));
	        	}
	        }
	...
	public void listar() {
		...
		TelefoneCollum.setCellValueFactory(new PropertyValueFactory<User, String>("Telefone"));
	...
	public void camposVisiveis(String titulo,String botao, int tamanho, boolean visivel) {
		...
		TxtTelefone.setDisable(visivel);
	...
	public boolean validacaoCampos() {
		...
		if(Txtemail.getText().isEmpty() | TxtName.getText().isEmpty() | TxtTelefone.getText().isEmpty()) {
			return false;
		}	
		return true;
	}
